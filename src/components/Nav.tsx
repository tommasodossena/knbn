...
export function Nav({ isCollapsed, links }: NavProps) {
  ...
  return (
    <div
      ...
      className="group w-full flex flex-col gap-4 py-2 max-h-[calc(100vh-182px)] overflow-y-auto"
    >
        ...
        {links.map((link, index) =>
          isCollapsed ? (
            ...
            <Link
              ...
              href={link.href ?? "#"}
              className={cn(
                buttonVariants({ variant: pathname === link.href ? "default" : "ghost", size: "sidebar" }),
                pathname === link.href &&
